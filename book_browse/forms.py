...
class BookSearch(forms.Form):
    search = forms.CharField(
        label="Поиск по названию книги", required=False, widget=forms.TextInput(attrs={'class': "field__input", 'id': 'search', 'autofocus': True, 
        'aria-label':"search", 'aria-describedby':"search", 'placeholder':'Поиск книги'}))
