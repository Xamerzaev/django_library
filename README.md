...
## Start with Docker
Before installation, make sure that your host machine supports virtualization, and that it is enabled.
For Windows: Make sure that you have Hyper-V enabled.

Then download and install Docker, Docker-Compose

Launch

Tilt the repository to yourself!
...
>>>>>>> c39dc927425f4ff9f6508dd67c7cbd42ae591c61
